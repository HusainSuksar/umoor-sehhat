...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-[#F4F9F6]">
      
      {/* 1. Emerald Hero Section */}
      <section className="relative overflow-hidden pt-16 pb-24 sm:pt-24 sm:pb-32 bg-gradient-to-b from-emerald-100/70 via-[#F4F9F6] to-[#F4F9F6] border-b border-emerald-100">
        
        {/* Soft Radial Ambient Lights */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-emerald-200/40 blur-[120px] rounded-full pointer-events-none -z-10" />

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            
            {/* Arabic Crest Tag */}
            <div className="inline-flex items-center gap-3 px-5 py-2 rounded-full bg-white border border-emerald-200/80 shadow-xs mb-8">
            ...
            {/* Main Header */}
            <h1 className="text-4xl sm:text-6xl lg:text-7xl font-black tracking-tight text-emerald-950 leading-[1.15] mb-6">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              >
                <FileUp className="w-5 h-5 text-emerald-600" /> Submit Medical Report
              </Link>
            </div>

            {/* Trust Metrics Bar */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-16 pt-8 border-t border-emerald-200/60">
              <div className="p-4 rounded-2xl bg-white border border-emerald-100 shadow-xs text-center">
              ...
              <div className="p-4 rounded-2xl bg-white border border-emerald-100 shadow-xs text-center">
                ...
                <div className="text-xs font-bold text-slate-500 uppercase tracking-wider mt-0.5">Encrypted Intake</div>
              </div>
              <div className="p-4 rounded-2xl bg-white border border-emerald-100 shadow-xs text-center">
      ...
      {/* 2. Institutional Healthcare Pillars */}
      <section className="py-20 bg-white border-b border-emerald-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="p-8 rounded-3xl bg-[#F8FAF9] border border-emerald-100/80 shadow-xs hover:shadow-xl hover:border-emerald-300 hover:-translate-y-1 transition-all duration-300">
      ...
      <section className="py-20 bg-[#F4F9F6]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-10 gap-4">
            ...
            <a 
              ...
              className="inline-flex items-center gap-2 text-xs sm:text-sm font-bold text-emerald-800 hover:text-emerald-900 bg-white hover:bg-emerald-50 border border-emerald-200 px-4 py-2 rounded-xl transition-all shadow-xs"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {MOCK_INSTAGRAM_POSTS.map((post) => (
              <div key={post.id} className="group cursor-pointer rounded-3xl overflow-hidden border border-emerald-100 bg-white shadow-xs hover:shadow-xl hover:border-emerald-300 hover:-translate-y-1 transition-all duration-300 flex flex-col">
